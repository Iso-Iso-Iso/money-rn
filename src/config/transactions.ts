import { CategoriesConfig } from "../modules/transactionForm/components/categoryPicker/types";

export const LOSS_CATEGORIES_CONFIG: CategoriesConfig = [
    ...
    { iconName: "directions-car", name: "Vehicle" },
    { iconName: "redeem", name: "gift" },
